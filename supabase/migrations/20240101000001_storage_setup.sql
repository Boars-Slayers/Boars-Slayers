...
-- 2. Política: Permitir que CUALQUIERA vea las fotos (Lectura pública)
...
-- 4. Política: Permitir actualización a usuarios autenticados
CREATE POLICY "Avatar Authenticated Update"
ON storage.objects FOR UPDATE
TO authenticated
USING ( bucket_id = 'avatars' );

-- 5. Política: Permitir borrado a usuarios autenticados
